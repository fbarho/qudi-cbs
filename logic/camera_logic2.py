...
##########################################################3
    ...
    def do_spooling(self, filenamestem, n_frames):
        ...
        path = self._create_generic_filename(filenamestem, '_RTMovie', 'movie', '', addfile=False)  # use an empty string for fileformat. this will be handled by the camera itself
    ...
    def save_video(self, filenamestem, n_frames):
        ...
        complete_path = self._create_generic_filename(filenamestem, '_RTMovie', 'movie', '.tiff', addfile=False)
        # create the PIL.Image object and save it to tiff
    ...
    def _create_generic_filename(self, filenamestem, folder, file, fileformat, addfile):
        ...
        example: /home/barho/images/2020-12-16/samplename/000_RTMovie/movie.tiff
        filenamestem is typically generated by the dialog in basic gui

        @params: str folder: specify the type of experiment (ex. RTMovie, Snap)
